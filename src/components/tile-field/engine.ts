...
const REST = "oklch(0.64 0.012 85)";
const BRAND_HUE = 85;
const GLOW_LCH = "0.52 0.11 85";
const SPARK = "184,149,44";
...
export class TileField {
  ...
  resize() {
    ...
    const fontFamily = getComputedStyle(stage).fontFamily;
  ...
  private frame = (t: number) => {
    const ctx = this.ctx;
    const { viewW, viewH, cell, n, px, py, rowOf, hueSeed, spark, lit, seed } =
      this;
